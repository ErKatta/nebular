...
export class NbCalendarWithTimeComponent<D> extends NbCalendarComponent<D> implements OnInit, AfterViewInit {
  ...
  @ViewChild(NbPortalOutletDirective, { static: false }) portalOutlet: NbPortalOutletDirective;
  @ViewChild(NbTimePickerComponent,  { static: false }) timepicker: NbTimePickerComponent<D>;
