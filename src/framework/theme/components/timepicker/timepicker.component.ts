...
import {NbPlatform} from '../cdk/overlay/mapping';
...
export class NbTimePickerComponent<D> implements OnChanges, OnInit {
  ...
  static ngAcceptInputType_twelveHoursFormat: NbBooleanInput = true;
  ...
  static ngAcceptInputType_withSeconds: NbBooleanInput = true;
